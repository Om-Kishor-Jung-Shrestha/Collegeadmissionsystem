  ...
  return (
    <section className="bg-white transition-colors duration-300 dark:bg-stone-900">
      <div className="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="rounded-2xl bg-[#173f35] px-6 py-12 dark:bg-[#102e27] sm:px-10 lg:px-14">
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-center">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">
                Explore where your education can take you.
              </h2>

              <p className="mt-5 text-base leading-7 text-stone-300">
                Discover our academic programs or begin your admission
                journey.
              </p>
            </div>
